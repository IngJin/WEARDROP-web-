...
<table id="table" style="width: 100%;">
	...
	<c:forEach items="${page.list }" var="vo">
			...
			<tr>
				...
				<td>
						<a onclick="location='detail.com?id=${vo.id}&code=${vo.code}&read=1'">
							<!--첨부파일 있는 경우에만 다운로드 이미지 나타내기-->
							<span class="ing_td">${vo.title }&nbsp;
							<%-- <font style="color: skyblue; font-weight: bold">${vo.replycnt}</font> --%>
	...
	<c:otherwise>
		...
		<div class="aside_block aside_box" style="float: right; z-index: 50; position:absolute; top:35%; left: 63%;" >
					...
					you can go <a href="list.com" style="text-decoration: underline;">Back to the list</a> 
					and Please enter another keyword!
					</p>
					<p>
					<span>
					<a href="list.com">← 목록으로 돌아가기</a>
					</span>
					</p> 
					<!-- 
					<p>
