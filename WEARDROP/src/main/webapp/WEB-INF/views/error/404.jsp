	...
	<div id="contents-holder">
		<div id="contents">
		 <a id="sign_in_logo" onclick="location='index'" style="cursor: pointer;"><img alt="엑박띠" src="img/icon/content_logo.png" style="width: 300px;"></a>
			<div id="errornum">
				<span id="error-h">4</span><span class="error-sep">:</span><span id="error-m">04</span><span class="error-sep">:</span><span id="error-s">00</span>
			</div>
			
			<h2 id="title"><br>Page not found!</h2>
			<p id="body">현재 페이지를 찾을 수 없습니다.<br>불편을 드려 죄송합니다.</p>
