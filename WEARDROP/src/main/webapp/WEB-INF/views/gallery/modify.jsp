		...
		<div class="rightside rightpix ootdDetail">
			...
			<div class="rs_header">
				<h2 class="rs_title"><input value="${vo.title }" type="text"
					title="제목" class="need" id="gal_title" name="title" style="width: 40%; background-color: #fff; font-size: 26px; font-weight: bold;" /></h2>
			...
			<div class="rs_body">
				...
				<div class="rs_textarea">
					<p><textarea title="내용" class="need"
    					...
    					" name="content" id="gal_content">${vo.content }</textarea></p>
				</div>
			...
			<!-- SNS 링크 -->
				...
				<div class='file-input'>
 				<input type='file' name="file" id="gdsImg"/>
  				...
  				<span class='label' data-js-label>${vo.filename}</label>
				</div>
				
				<script type="text/javascript">
				MarcTooltips.add('#gdsImg', '이미 첨부되어 있는 사진을 수정하시려면 "Choose Pic!"을 눌러주세요!');
				</script>
				...
				<div class="btnwrap">
					...
					<div class="ing_btn">
						...
						<a onclick="location.href='detail.gal?id=${vo.id}'">Cancel</a>
					</div>
