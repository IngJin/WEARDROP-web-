...
<div id="weardrop_wrap">
	...
	<!-- 본문 -->
	<div id="weardrop_contents" style="margin-left: 175px;">
		...
		<div id="ingjin_main">
			...
			<aside>
				...
				<div class="aside_block">
					<h3>DailyLook?</h3>
					<div class="item">
						<p>데일리룩 게시판입니다.<span class="right"></span></p>
					</div>
					<div class="item">
						<p>당신의 데일리룩을 공유해주세요!<span class="right"></span></p>
					</div>
				</div>
				...
				<div class="aside_block">
					...
					<c:choose>
						<c:when test="${!empty info_login }"> 
							...
							<div class="ing_eff_yes" style="color: #000;"></div>
								<a style="cursor: pointer; color: #fff;" onclick="location='new.gal'">Write</a>
							</div>
						</c:when>
						<c:otherwise>
				...
				<div class="aside_block">
					...
					<div class="ingstagram">
						<a href="https://www.instagram.com/weardrop_official" target="_blank">
				...
				<div class="aside_block aside_box">
					...
					Technical support : INGJIN
					<img class="gal_icon" src="img/icon/paintbrush_icon.png" style="margin-left: 5px;" />
					</p>
			...
			<section style="width:80%; height:100%;">
				<h2><img src='img/icon/list_icon_white.png' class="section_icon"/>Gallery LIST</h2>
				<!-- 본문 -->
			...
			<%-- 	<div class="grid">
					...
					<figure class="effect-julia">
						<img src="<c:url value='/'/>${vo.filepath}" alt="사진이었던것"/>
						<figcaption>
		...
		<div class="aside_block aside_box" style="float: right; z-index: 50; position:absolute; top:35%; left:75%;" >
					...
					you can go <a href="list.gal" style="text-decoration: underline;">Back to the list</a> 
					and Please enter another keyword!
					</p>
					<p>
					<span>
					<a href="list.gal">← 목록으로 돌아가기</a>
					</span>
					</p> 
					<!-- 
					<p>
