...
<c:forEach items="${list }" var="vo" varStatus="status">
	...
	<div style="margin-bottom: 10px; font-size: 14px;">
		<!-- 아이디 아이콘-->
			<img src="img/icon/gal_user_icon.png" style="width:15.5px; height:15.5px;  vertical-align:bottom"/>
		<!-- 작성자/작성일 -->
			<span>
				${vo.writer}
	...
	<!-- 댓글이 표시되는 부분  -->
	<div style="font-size:14px; margin-bottom: 10px;" id="original-${vo.id}">
...
function go_modify_save(id) {
	...
	var tag = "<textarea id='edit-" + id + "' style='margin-top:5px; width:99%; height:40px;'>" //텍스트창 호출 
