...
<form action="insert.ct" method="post" enctype="multipart/form-data">
	<!-- 메뉴 -->
	...
	<div id="weardrop_contents">
		<div class="modify_bg" style="position: absolute; background-color: rgba(0, 0, 0, 0.2); width: 100%; height: 100vh; left: 0; top: 0; z-index: 10;"></div>
		<header>
			<h1 style="color: #fff;">Q&A</h1>
		</header>
		<!-- 디자인 메인 -->
		<div id="ingjin_main">
		<div class="modify_bg" style="position: fixed; background-color: rgba(0, 0, 0, 0.4); width: 100%; height: 100vh; left: 0; top: 0; z-index: -10;"></div>
			...
			<aside>
				...
				<div class="aside_block" style="background-color: #fff;">
					...
					<div class="item">
						<p>자주 묻는 질문을 작성해주세요!<span class="right"></span></p>
					</div>
				</div>
					...
					<div class="post_header">
						<h2 class="post_title">
							<input id="post_title" value="${vo.title }" type="text" class="need" title="제목" placeholder="제목을 입력해주세요!" name="title"
								style="width: 70%; background-color: #fff; font-size: 26px; font-weight: bold; border-bottom: dotted 1px #000;" />
						</h2>
				...
				<div class="comment_block">
					...
					<div class="ing_btn" style="width: 140px; margin-top: 10px;">
						<div class="ing_eff_not"></div>
							<a onclick="location='manager.list'">Cancel</a>
						</div>
					</div>
			</comment>
