...
&nbsp; ① 본 약관은 회원가입 화면에 게시하여 공시하며 회사는 사정변경 및 영업상 중요한 사유가 있을 경우 약관을 변경할 수<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;있으며 변경된 약관은 공지사항을 통해 공시한다.<br/>
...
<div class="list">
제 5 조 (이용신청)<br/>
&nbsp; ① 이용신청자가 회원가입 안내에서 본 약관과 개인정보보호정책에 동의하고 등록절차(회사의 소정 양식의 가입 신청서 작성)<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;를 거쳐 '확인' 버튼을 누르면 이용신청을 할 수 있다.<br/>
...
&nbsp; ② 회사는 이용자로부터 제기되는 의견이나 불만이 정당하다고 인정될 경우에는 즉시 처리해야 한다. <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;단, 즉시 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을 공지사항 또는 전자우편을 통해 통보해야 한다.<br/>
&nbsp; ③ 제1항의 경우 수사상의 목적으로 관계기관 및 정보통신윤리위원회의 요청이 있거나 영장 제시가 있는 경우, <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기타 관계 법령에 의한 경우는 예외로 한다.<br/>
<br/>
제 8 조 (이용자의 의무)<br/>
&nbsp; ① 이용자는 본 약관 및 회사의 공지사항, 사이트 이용안내 등을 숙지하고 준수해야 하며 기타 회사의 업무에 방해되는 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;행위를 해서는 안된다.<br/>
&nbsp; ② 이용자는 회사의 사전 승인 없이 본 사이트를 이용해 어떠한 영리행위도 할 수 없다.<br/>
&nbsp; ③ 이용자는 본 사이트를 통해 얻는 정보를 회사의 사전 승낙 없이 복사, 복제, 변경, 번역, 출판, 방송 및 기타의 방법으로 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;사용하거나 이를 타인에게 제공할 수 없다.<br/> 
</div>
<br/>
...
&nbsp; ② 본 약관에 명시되지 않은 서비스 이용에 관한 사항은 회사가 정해 '공지사항'에 게시하거나<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;또는 별도로 공지하는 내용에 따른다.<br/>
<br/>
제 10 조 (정보의 제공)<br/>
...
&nbsp; ② 회사는 사이트에 게재되어 있는 광고주의 판촉활동에 회원이 참여하거나 교신 또는 거래의 결과로서 발생하는 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;모든 손실 또는 손해에 대해 책임을 지지 않는다.<br/>
<br/>
...
&nbsp; ③ 회사는 이용자가 게시판에 게재한 정보, 자료, 내용 등에 관하여 사실의 정확성, 신뢰도 등에 어떠한 책임도 부담하지 않으며 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이용자는 본인의 책임 아래 본 사이트를 이용해야 한다.<br/>
&nbsp; ④ 이용자가 게시 또는 전송한 자료 등에 관하여 손해가 발생하거나 자료의 취사선택, 기타 무료로 제공되는 서비스 이용과<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;관련해 어떠한 불이익이 발생하더라도 이에 대한 모든 책임은 이용자에게 있다.<br/>
&nbsp; ⑤ 아이디와 비밀번호의 관리 및 이용자의 부주의로 인하여 발생되는 손해 또는 제3자에 의한 부정사용 등에 대한 책임은 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이용자에게 있다.<br/>
&nbsp; ⑥ 이용자가 본 약관의 규정을 위반함으로써 회사에 손해가 발생하는 경우 이 약관을 위반한 이용자는 회사에 발생한 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;모든 손해를 배상해야 하며 동 손해로부터 회사를 면책시켜야 한다.<br/>
<br/>
제 17 조 (개인신용정보 제공 및 활용에 대한 동의서)<br/>
...
&nbsp; ② 제1항의 규정에도 불구하고 동 분쟁으로 인하여 소송이 제기될 경우 동 소송은 회사의 본사 소재지를 관할하는 <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;법원의 관할로 본다.<br/>
